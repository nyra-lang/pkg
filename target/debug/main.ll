...
entry:
  ...
  %ld.2196 = load ptr, ptr %alloca.2175
  call void @heap_free(ptr %ld.2196)
  %ld.2197 = load ptr, ptr %alloca.2181
  call void @heap_free(ptr %ld.2197)
  %ld.2198 = load ptr, ptr %alloca.2187
...
then.457:
  ...
  %ld.2944 = load ptr, ptr %alloca.2889
  call void @heap_free(ptr %ld.2944)
  %ld.2945 = load ptr, ptr %alloca.2922
...
then.604:
  ...
  %ld.3222 = load ptr, ptr %alloca.3215
  call void @heap_free(ptr %ld.3222)
  %ld.3223 = load ptr, ptr %alloca.3204
